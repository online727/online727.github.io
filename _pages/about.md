...
目前在[黄锐老师](https://nubs.nju.edu.cn/hr/list.htm)指导下，进行**机器学习与金融数据分析**方面的研究，具体研究方向为 GAN 在金融数据生成中的应用。

除之前的实习、项目经历外，目前正在**兴业证券金融工程组**从事股票高频方向的实习。
